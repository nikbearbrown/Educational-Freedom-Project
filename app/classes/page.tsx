    ...
    <div className="container px-4 md:px-6 mx-auto py-12 bg-black">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <div className="relative w-full aspect-video rounded-lg overflow-hidden mb-8 border border-gray-800">
            <iframe
        ...
        <div className="grid gap-12">
            ...
            <div className="grid gap-6">
              ...
              <div className="border border-gray-700 rounded-lg p-6 bg-gray-900">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-3 text-white">CSYE 7270: Building Virtual Environments</h3>
                    <p className="mb-4 text-gray-300">
              ...
              <div className="border border-gray-700 rounded-lg p-6 bg-gray-900">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-3 text-white">INFO 6105: Data Science Engineering Methods</h3>
                    <p className="mb-4 text-gray-300">
              ...
              <div className="border border-gray-700 rounded-lg p-6 bg-gray-900">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-3 text-white">CSYE 7370: Deep Reinforcement Learning Game Engineering</h3>
                    <p className="mb-4 text-gray-300">
              ...
              <div className="border border-gray-700 rounded-lg p-6 bg-gray-900">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-3 text-white">INFO 7390: Advances in Data Sciences and Architecture</h3>
                    <p className="mb-4 text-gray-300">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="border border-gray-700 rounded-lg overflow-hidden">
                ...
                <div className="p-4 bg-gray-900">
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                      <span className="text-gray-300">CSYE 7270: Building Virtual Environments*</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                      <span className="text-gray-300">INFO 6105: Data Sci Eng Methods</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                      <span className="text-gray-300">INFO 7390: Advances Data Sci/Architecture</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                      <span className="text-gray-300">CSYE 7370: Deep Reinforcement Learning Game Eng*</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                      <span className="text-gray-300">DAMG 6210: Data Mgt and Database Design</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                      <span className="text-gray-300">INFO 7375: ST: AI Engineering Apps* - Prompt Engineering and GenAI</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                      <span className="text-gray-300">CSYE 7374: Special Topics: Computational Skepticism*</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                      <span className="text-gray-300">INFO 6210: Data Mgt and Database Design</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                      <span className="text-gray-300">CSYE 7245: Big Data Sys Int Analytics</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="border border-gray-700 rounded-lg overflow-hidden">
                ...
                <div className="p-4 bg-gray-900">
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                      <span className="text-gray-300">DA 5030: Intro Data Mining/Machine Lrn</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                      <span className="text-gray-300">CS 3540: Game Programming</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                      <span className="text-gray-300">CS 4300: Computer Graphics</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                      <span className="text-gray-300">CS 4850: Building Game Engines</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                      <span className="text-gray-300">CS 5850: Advanced Building Game Engines</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                      <span className="text-gray-300">DS 6020: Collect/Store/Retrieve Data</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                      <span className="text-gray-300">DS 6030: Intro Data Mining/Machine Lrn</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                      <span className="text-gray-300">CS 4800: Algorithms Data</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                      <span className="text-gray-300">ENGR-0201: AI for Personalized Learning</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                      <span className="text-gray-300">INFO 7375: Branding and AI</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="border border-gray-700 rounded-lg overflow-hidden">
                ...
                <div className="p-4 bg-gray-900">
                  <div className="mb-4">
                    <h4 className="font-medium text-white mb-2">UCLA</h4>
                  ...
                  <div className="mb-4">
                    <h4 className="font-medium text-white mb-2">Santa Monica College</h4>
                    <ul className="space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                  ...
                  <div className="mb-4">
                    <h4 className="font-medium text-white mb-2">Arts Institutes</h4>
                    <ul className="space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                  ...
                  <div>
                    <h4 className="font-medium text-white mb-2">LA Film School</h4>
                    <ul className="space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2"></span>
                        <span className="text-gray-300">Game Programming</span>
              ...
              <div className="border border-gray-700 rounded-lg overflow-hidden">
                ...
                <div className="p-4 bg-gray-900">
                  <p className="mb-4 text-gray-300">Course materials, lecture notes, and code samples are available through the following channels:</p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <strong className="block text-white">GitHub Repositories</strong>
                        <a href="https://github.com/nikbearbrown" className="text-sm text-gray-400 hover:text-white">github.com/nikbearbrown</a>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-8 h-8 bg-gray-700 rounded-full flex items-center justify-center flex-shrink-0">
                      ...
                      <div>
                        <strong className="block text-white">YouTube Channel</strong>
                        <a href="https://www.youtube.com/user/nikbearbrown" className="text-sm text-gray-400 hover:text-white">youtube.com/user/nikbearbrown</a>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-8 h-8 bg-gray-700 rounded-full flex items-center justify-center flex-shrink-0">
                      ...
                      <div>
                        <strong className="block text-white">Canvas Course Sites</strong>
                        <span className="text-sm text-gray-400">Available to enrolled students</span>
                      </div>
                    </li>
                  </ul>
                </div>
          ...
          <section>
            <h2 className="text-3xl font-bold mb-6 text-white">Current Projects & Initiatives</h2>
