  ...
  return (
    <div className="container px-4 md:px-6 mx-auto py-12">
      <div className="max-w-4xl mx-auto">
        {/* Hero Section */}
        <div className="mb-16">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Teaching Portfolio</h1>
        ...
        <section className="mb-16">
          ...
          <div className="prose prose-lg dark:prose-invert bg-blue-50 dark:bg-blue-900/10 p-6 rounded-lg border border-blue-200 dark:border-blue-800">
            <p>
        ...
        <section>
          ...
          <div className="mb-12">
            ...
            <div className="grid gap-4">
              <div className="border rounded-lg p-4 bg-gradient-to-r from-red-50 to-white dark:from-red-900/10 dark:to-transparent">
          ...
          <div className="mb-12">
            ...
            <div className="grid gap-4">
              <div className="border rounded-lg p-4 bg-gradient-to-r from-blue-50 to-white dark:from-blue-900/10 dark:to-transparent">
          ...
          <div className="mb-12">
            ...
            <div className="grid gap-4">
              <div className="border rounded-lg p-4 bg-gradient-to-r from-green-50 to-white dark:from-green-900/10 dark:to-transparent">
          ...
          <div className="mb-12">
            ...
            <div className="grid gap-4">
              <div className="border rounded-lg p-4 bg-gradient-to-r from-purple-50 to-white dark:from-purple-900/10 dark:to-transparent">
          ...
          <div className="mb-12">
            ...
            <div className="grid gap-4">
              <div className="border rounded-lg p-4 bg-gradient-to-r from-amber-50 to-white dark:from-amber-900/10 dark:to-transparent">
                <h4 className="font-bold">Game Programming</h4>
        ...
        <section className="mt-16">
          ...
          <div className="grid gap-4">
            <div className="border rounded-lg p-4 bg-gradient-to-r from-yellow-50 to-white dark:from-yellow-900/10 dark:to-transparent">
        ...
        <section className="mt-16">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg p-8">
            ...
            <div className="flex flex-wrap gap-4">
              <PrimaryButton href="/contact" className="bg-white text-blue-600 hover:bg-gray-100">
                Contact Me
              </PrimaryButton>
